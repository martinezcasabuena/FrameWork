...
public class Functions_open_users {
	...
	public static ArrayList<Normal> AutoOpenTxtNormal() {
        ...
        try {
            File f;
            PATH=new java.io.File(".").getCanonicalPath()+ "/src/FrameWork_Dani/modulos/user/Model/Archivos_user/normal/archivos/normal.txt";
            f = new File(PATH);
	...
	public static ArrayList<Normal> OnDemandOpenXmlNormal() {
		...
		public static ArrayList<Normal> AutoOpenXmlNormal() {
	    	...
	    	try {
	            XStream xstream = new XStream();
	            Annotations.configureAliases(xstream, Normal.class);
	            PATH=new java.io.File(".").getCanonicalPath()+ "/src/FrameWork_Dani/modulos/user/Model/Archivos_user/normal/archivos/normal.xml";
                Singleton.userNormal = (ArrayList <Normal>)xstream.fromXML(new FileReader(PATH));
	        } catch (Exception e1) {
	        	JOptionPane.showMessageDialog(null, Language.getInstance().getProperty("error_xml_open"), Language.getInstance().getProperty("error"), JOptionPane.ERROR_MESSAGE);
	        }
	...
	public static ArrayList<Normal> AutoOpenJsonNormal() {
        ...
        try {
	          ...
	          PATH=new java.io.File(".").getCanonicalPath()+ "/src/FrameWork_Dani/modulos/user/Model/Archivos_user/normal/archivos/normal.json";
	...
	//--------------CLIENTE USER OPEN TXT--------------//
		...
		public static ArrayList<Cliente> AutoOpenTxtClient() {
	        ...
	        try {
	            File f;
	            PATH=new java.io.File(".").getCanonicalPath()+ "/src/FrameWork_Dani/modulos/user/Model/Archivos_user/cliente/archivos/cliente.txt";
	            f = new File(PATH);
		...
		public static ArrayList<Cliente> OnDemandOpenXmlClient() {
			...
			public static ArrayList<Cliente> AutoOpenXmlClient() {
		    	...
		    	try {
		            XStream xstream = new XStream();
		            Annotations.configureAliases(xstream, Cliente.class);
		            PATH=new java.io.File(".").getCanonicalPath()+ "/src/FrameWork_Dani/modulos/user/Model/Archivos_user/cliente/archivos/cliente.xml";
	                Singleton.userCliente = (ArrayList <Cliente>)xstream.fromXML(new FileReader(PATH));
		        } catch (Exception e1) {
		        	JOptionPane.showMessageDialog(null, Language.getInstance().getProperty("error_xml_open"), Language.getInstance().getProperty("error"), JOptionPane.ERROR_MESSAGE);
		        }
		...
		public static ArrayList<Cliente> AutoOpenJsonClient() {
	        ...
	        try {
		          ...
		          PATH=new java.io.File(".").getCanonicalPath()+ "/src/FrameWork_Dani/modulos/user/Model/Archivos_user/cliente/archivos/cliente.json";
		...
		public static ArrayList<Admin> AutoOpenTxtAdmin() {
	        ...
	        try {
	            File f;
	            PATH=new java.io.File(".").getCanonicalPath()+ "/src/FrameWork_Dani/modulos/user/Model/Archivos_user/admin/archivos/admin.txt";
	            f = new File(PATH);
		...
		public static ArrayList<Admin> OnDemandOpenXmlAdmin() {
			...
			public static ArrayList<Admin> AutoOpenXmlAdmin() {
		    	...
		    	try {
		            XStream xstream = new XStream();
		            Annotations.configureAliases(xstream, Admin.class);
		            PATH=new java.io.File(".").getCanonicalPath()+ "/src/FrameWork_Dani/modulos/user/Model/Archivos_user/admin/archivos/admin.xml";
	                Singleton.userAdmin = (ArrayList <Admin>)xstream.fromXML(new FileReader(PATH));
		        } catch (Exception e1) {
		        	JOptionPane.showMessageDialog(null, Language.getInstance().getProperty("error_xml_open"), Language.getInstance().getProperty("error"), JOptionPane.ERROR_MESSAGE);
		        }
		...
		public static ArrayList<Admin> AutoOpenJsonAdmin() {
	        ...
	        try {
		          ...
		          PATH=new java.io.File(".").getCanonicalPath()+ "/src/FrameWork_Dani/modulos/user/Model/Archivos_user/admin/archivos/admin.json";
