	...
	public static void deleteNormal () {
		...
		if(Singleton.userNormal.isEmpty()){
			...
			if (location != -1) {
				...
				JOptionPane.showMessageDialog(null,Settings.getInstance().lang.getProperty("del_user"), Settings.getInstance().lang.getProperty("del_user"), JOptionPane.ERROR_MESSAGE);
			}else {
				JOptionPane.showMessageDialog(null,Settings.getInstance().lang.getProperty("no_user"), Settings.getInstance().lang.getProperty("error"), JOptionPane.ERROR_MESSAGE);
			}
		}
